...
# Load SHR to swap
shareledger tx gm load $(shareledger keys show authority -a) 10000000shr --from authority --yes -b block
shareledger tx swap deposit 10000000shr --from authority --yes -b block
