...
//	v, err := denom.NormalizeToBaseCoin(denom.Base, sdk.NewDecCoins(sdk.NewDecCoinFromDec(denom.Shr, decShr)), rate, true)
//	if err != nil {
//		return nil, err
//	}
//	amt := v.Amount
...
//		if err := k.buyBaseDenom(ctx, baseToBuy, msg.GetSigners()[0]); err != nil {
