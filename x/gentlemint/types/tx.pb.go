...
type MsgLoadFee struct {
	Creator string `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	Shrp    string `protobuf:"bytes,2,opt,name=shrp,proto3" json:"shrp,omitempty"`
}
...
func (m *MsgLoadFee) GetShrp() string {
	if m != nil {
		return m.Shrp
	}
	return ""
...
var fileDescriptor_d3542f4930ea9a46 = []byte{
	...
	,
}
...
func (m *MsgLoadFee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Shrp) > 0 {
		i -= len(m.Shrp)
		copy(dAtA[i:], m.Shrp)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Shrp)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
...
func (m *MsgLoadFee) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Shrp = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
