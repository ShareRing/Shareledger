...
import (
	...
	"github.com/sharering/shareledger/x/gentlemint/ante"
...
func (s *IntegrationTestSuite) TestGlobalFeeMinimumGasFeeAnteHandler() {
	...
	globalfeeParamsEmpty := &types.Params{MinimumGasPrices: []sdk.DecCoin{}}
	minGasPriceEmpty := []sdk.DecCoin{}
	globalfeeParams0 := &types.Params{MinimumGasPrices: []sdk.DecCoin{
		sdk.NewDecCoinFromDec("photon", sdk.NewDec(0)),
		sdk.NewDecCoinFromDec("uatom", sdk.NewDec(0)),
	}}
	globalfeeParamsContain0 := &types.Params{MinimumGasPrices: []sdk.DecCoin{
	...
	globalfeeParamsHigh := &types.Params{
	...
	globalfeeParamsLow := &types.Params{
		MinimumGasPrices: []sdk.DecCoin{
			sdk.NewDecCoinFromDec("uatom", low),
		},
	}
	// global fee must be sorted in denom
	globalfeeParamsNewDenom := &types.Params{
		MinimumGasPrices: []sdk.DecCoin{
