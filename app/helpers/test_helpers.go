...
const (
	SimAppChainID = "shareledger-app"
)

// DefaultConsensusParams defines the default Tendermint consensus params used
// in ShareledgerApp testing.
...
// SetupWithGenesisValSet initializes a new ShareledgerApp with a validator set and genesis accounts
// that also act as delegators. For simplicity, each validator is bonded with a delegation
// of one consensus engine unit in the default token of the ShareledgerApp from first genesis
// account. A Nop logger is set in ShareledgerApp.
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, balances ...banktypes.Balance) *shareledgerapp.App {
	t.Helper()
...
func genesisStateWithValSet(t *testing.T,
	app *shareledgerapp.App, genesisState shareledgerapp.GenesisState,
	valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount,
	balances ...banktypes.Balance,
) shareledgerapp.GenesisState {
