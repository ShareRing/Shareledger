...
type MsgRequestIn struct {
	...
	Amount        *types.DecCoin `protobuf:"bytes,5,opt,name=amount,proto3" json:"amount,omitempty"`
	Fee           *types.DecCoin `protobuf:"bytes,6,opt,name=fee,proto3" json:"fee,omitempty"`
	TxEventHashes []string       `protobuf:"bytes,7,rep,name=txEventHashes,proto3" json:"txEventHashes,omitempty"`
}
...
func (m *MsgRequestIn) GetTxEventHashes() []string {
	if m != nil {
...
var fileDescriptor_e6107e4e71e75faa = []byte{
	...
	,
}
...
func (m *MsgRequestIn) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TxEventHashes) > 0 {
		for iNdEx := len(m.TxEventHashes) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTx(dAtA, i, uint64(len(m.TxEventHashes[iNdEx])))
			i--
			dAtA[i] = 0x3a
		}
	}
