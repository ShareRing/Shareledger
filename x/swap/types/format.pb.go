...
func (*Format) Descriptor() ([]byte, []int) {
	return fileDescriptor_60e76b8264b14264, []int{0}
}
...
func (m *Format) GetNetwork() string {
	if m != nil {
		return m.Network
	}
	return ""
...
func (m *Format) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *Format) GetDataFormat() string {
	if m != nil {
		return m.DataFormat
	}
	return ""
...
func init() {
	proto.RegisterType((*Format)(nil), "shareledger.swap.Format")
}

func init() { proto.RegisterFile("swap/format.proto", fileDescriptor_60e76b8264b14264) }

var fileDescriptor_60e76b8264b14264 = []byte{
	// 194 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Format) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.DataFormat) > 0 {
		...
		i = encodeVarintFormat(dAtA, i, uint64(len(m.DataFormat)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Creator) > 0 {
		...
		i = encodeVarintFormat(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Network) > 0 {
		...
		i = encodeVarintFormat(dAtA, i, uint64(len(m.Network)))
		i--
		dAtA[i] = 0xa
	}
...
func skipFormat(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupFormat
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupFormat = fmt.Errorf("proto: unexpected end of group")
)
