...
var fileDescriptor_e243c29ad9ae20da = []byte{
	...
	0x8b, 0xf4, 0xa0, 0xea, 0x94, 0x02, 0xb9, 0xd8, 0x7d, 0x8b, 0xd3, 0x9d, 0xf2, 0xf3, 0xb3, 0x85,
	0xc4, 0xb8, 0xd8, 0x40, 0xa2, 0xa9, 0x45, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x50, 0x9e,
	...
	0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xd8, 0xb4, 0x22, 0x50, 0x3c, 0x23, 0x99, 0xab, 0x5f,
	0xa1, 0x0f, 0x8f, 0xfd, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0x0a, 0x30, 0x06, 0x04, 0x00,
	0x00, 0xff, 0xff, 0xf3, 0x32, 0xe5, 0x7f, 0x15, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) Book(ctx context.Context, in *MsgBook, opts ...grpc.CallOption) (*MsgBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ShareRing.shareledger.booking.Msg/Book", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Book_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ShareRing.shareledger.booking.Msg/Book",
	}
