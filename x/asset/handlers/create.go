...
// NewHandler ...
func NewHandler(k asset.Keeper) sdk.Handler {
...
func handleAssetCreation(ctx sdk.Context, k asset.Keeper, msg messages.MsgCreate) sdk.Result {
...
func handleAssetRetrieval(ctx sdk.Context, k asset.Keeper, msg messages.MsgRetrieve) sdk.Result {
...
func handleAssetUpdate(ctx sdk.Context, k asset.Keeper, msg messages.MsgUpdate) sdk.Result {
...
func handleAssetDelete(ctx sdk.Context, k asset.Keeper, msg messages.MsgDelete) sdk.Result {
