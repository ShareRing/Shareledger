...
func TestIdCreate_Success(t *testing.T) {
	...
	// Enroll id signer
	f.EnrollIdSigner([]sdk.AccAddress{issuer}, fmt.Sprintf("--from %s --yes --fees 1000000000shr", accountOperator.String()))

	// wait for a block confirmation
	tests.WaitForNextNBlocksTM(1, f.Port)

	f.CreateId(id, backup, owner, extraData, fmt.Sprintf("--from %s --yes --fees 1000000000shr", issuer.String()))
...
func TestIdCreate_LowFee(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	revokeRs, stdOut, _ := f.CreateId(id, backup, owner, extraData, fmt.Sprintf("--from %s --yes --fees 100000shr", issuer.String()))
...
func TestIdCreateInBatch_Success(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	f.CreateIdInBatch(ids, backups, owners, extras, fmt.Sprintf("--from %s --yes --fees 1000000000shr", issuer.String()))
...
func TestIdCreateInBatch_LowFee(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	revokeRs, stdOut, _ := f.CreateIdInBatch(ids, backups, owners, extras, fmt.Sprintf("--from %s --yes --fees 10000000shr", issuer.String()))

	// wait for a block confirmation
	tests.WaitForNextNBlocksTM(1, f.Port)

	require.True(t, revokeRs)
	require.Contains(t, stdOut, "required: 1800000000shr")
...
func TestIdCreateInBatch_CallerIsNotIdSigner(t *testing.T) {
	...
	_, stdOut, _ := f.CreateIdInBatch(ids, backups, owners, extras, fmt.Sprintf("--from %s --yes --fees 1000000000shr", treasurer.String()))
...
func TestIdCreate_CallerIsNotIssuer(t *testing.T) {
	...
	_, stdOut, _ := f.CreateId(id, backup, owner, extraData, fmt.Sprintf("--from %s --yes --fees 1000000000shr", issuer.String()))
...
func TestIdUpdate_Success(t *testing.T) {
	...
	f.UpdateId(id, newExtradata, fmt.Sprintf("--from %s --yes --fees 1000000000shr", issuer.String()))
...
func TestIdUpdate_LowFee(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	revokeRs, stdOut, _ := f.UpdateId(id, newExtradata, fmt.Sprintf("--from %s --yes --fees 10000shr", issuer.String()))
	require.True(t, revokeRs)
	require.Contains(t, stdOut, "600000000shr")
...
func TestIdUpdate_CallerIsNotIdSigner(t *testing.T) {
	...
	// Update id
	newExtradata := "newExtradata"
	_, stdOut, _ := f.UpdateId(id, newExtradata, fmt.Sprintf("--from %s --yes --fees 1000000000shr", user3.String()))
...
func TestIdReplaceOwner_Success(t *testing.T) {
	...
	// Update id
	f.ReplaceIdOwner(id, backup, fmt.Sprintf("--from %s --yes --fees 1000000000shr", backup.String()))
...
func TestIdReplaceOwner_LowFee(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	revokeRs, stdOut, _ := f.ReplaceIdOwner(id, backup, fmt.Sprintf("--from %s --yes --fees 100000shr", backup.String()))
...
func TestIdReplaceOwner_CallerIsNotBackup(t *testing.T) {
	...
	// Update id
	_, stdOut, _ := f.ReplaceIdOwner(id, backup, fmt.Sprintf("--from %s --yes --fees 1000000000shr", issuer.String()))
