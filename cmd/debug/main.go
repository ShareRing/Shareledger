...
import (
	...
	shareledger "bitbucket.org/shareringvietnam/shareledger-fix"
...
var rootCmd = &cobra.Command{
	Use:          "shareledgerdebug",
	Short:        "shareledger debug tool",
	SilenceUsage: true,
}

var txCmd = &cobra.Command{
	Use:   "tx",
	Short: "Decode a shareledger tx from hex or base64",
	RunE:  runTxCmd,
}
