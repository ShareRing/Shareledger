...
// 	// Run the test cases using the helper function
// 	tests.RunTestCases(&s.Suite, testCases, cli.CmdAccountOperator(), s.network.Validators[0])
// }

// func (s *E2ETestSuite) TestCmdAccountOperators() {
// 	testCases := tests.TestCases{
// 		{
...
// 		},
// 		{
// 			Name:      "query account operators by address empty",
// 			Args:      []string{},
// 			ExpectErr: true,
// 			RespType:  &types.QueryAccountOperatorsResponse{},
// 			// Expected:  nil,
// 		},
// 		{
// 			Name:      "query account operators by address not exists",
// 			Args:      []string{"address2"},
// 			ExpectErr: true,
// 			RespType:  nil,
// 			Expected:  nil,
...
// 		},
// 		{
// 			Name:      "query voters by address empty",
// 			Args:      []string{},
// 			ExpectErr: true,
// 			RespType:  &types.QueryVotersResponse{},
// 		},
// 		{
// 			Name:      "query voters by address not exists",
// 			Args:      []string{"address2"},
// 			ExpectErr: true,
// 			RespType:  nil,
// 			Expected:  nil,
...
// 		},
// 		{
// 			Name:      "query loaders by address empty",
// 			Args:      []string{},
// 			ExpectErr: true,
// 			RespType:  &types.QueryLoadersResponse{},
// 		},
// 		{
// 			Name:      "query loaders by address not exists",
// 			Args:      []string{"address2"},
// 			ExpectErr: true,
// 			RespType:  nil,
// 			Expected:  nil,
...
// 		},
// 		{
// 			Name: "query loaders from file by address not exists",
// 			Args: []string{
// 				"notExistsAddress",
// 			},
// 			RespType:  &types.QueryLoaderResponse{},
