...
//func New(t *testing.T, cfg network.Config) *Network {
...
//		T:          t,
//		BaseDir:    baseDir,
//		Validators: make([]*network.Validator, cfg.NumValidators),
//		Config:     cfg,
//	}
//
...
//	Accounts := make(map[string]sdk.Address)
//	var (
...
//		nodeDir := filepath.Join(testNetwork.BaseDir, nodeDirName, "shareledgerd")
//		clientDir := filepath.Join(testNetwork.BaseDir, nodeDirName, "shareledgercli")
//		gentxsDir := filepath.Join(testNetwork.BaseDir, "gentxs")
//
...
//
//		testNetwork.Validators[i] = &network.Validator{
//			AppConfig:  appCfg,
//			ClientCtx:  clientCtx,
//			Ctx:        ctx,
//			Dir:        filepath.Join(testNetwork.BaseDir, nodeDirName),
//			NodeID:     nodeID,
//			PubKey:     pubKey,
//			Moniker:    nodeDirName,
...
//
//	info, _, err := testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyAuthority, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyAuthority] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyTreasurer, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyTreasurer] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyOperator, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyOperator] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyIDSigner, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyIDSigner] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyDocIssuer, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyDocIssuer] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyMillionaire, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyMillionaire] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyLoader, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyLoader] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyEmpty1, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyEmpty1] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyEmpty2, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyEmpty2] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//		Coins:   poorMen,
//	})
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyEmpty3, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyEmpty3] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//		Coins:   poorMen,
//	})
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyEmpty4, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyEmpty4] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyEmpty5, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyEmpty5] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyAccount1, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyAccount1] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyAccount2, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyAccount2] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//		Coins:   defaultCoins,
//	})
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyAccount3, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyAccount3] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	})
//
//	info, _, err = testNetwork.Validators[0].ClientCtx.Keyring.NewMnemonic(KeyAccount4, keyring.English, sdk.FullFundraiserPath, keyring.DefaultBIP39Passphrase, hd.Secp256k1)
//	require.NoError(t, err, "init fail")
//	Accounts[KeyAccount4] = info.GetAddress()
//	genAccounts = append(genAccounts, authtypes.NewBaseAccount(info.GetAddress(), info.GetPubKey(), 0, 0))
//	genBalances = append(genBalances, banktypes.Balance{
...
//	require.NoError(t, collectGenFiles(cfg, testNetwork.Validators, testNetwork.BaseDir))
//	testNetwork.Accounts = Accounts
//	t.Log("starting test network...")
//	for _, v := range testNetwork.Validators {
...
//	server.TrapSignal(testNetwork.Cleanup)
//
//	return testNetwork
//}
//
