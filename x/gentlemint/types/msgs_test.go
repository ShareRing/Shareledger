...
func TestAddShrpCoins(t *testing.T) {
	...
	testCases := []testCase{
		{
			ic: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1)), sdk.NewCoin(denom.Cent, sdk.NewInt(0))),
			ia: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1)), sdk.NewCoin(denom.Cent, sdk.NewInt(0))),
			oa: AdjustmentCoins{
				Add: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1))),
				Sub: sdk.NewCoins(sdk.NewCoin(denom.Cent, sdk.NewInt(0))),
			},
			d: "1 shrp + 1 shrp = 2 shrp -> add: 1 shrp, sub 0 cent",
		},
		{
			ic: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1)), sdk.NewCoin(denom.Cent, sdk.NewInt(50))),
			ia: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1)), sdk.NewCoin(denom.Cent, sdk.NewInt(50))),
			oa: AdjustmentCoins{
				Add: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(2))),
				Sub: sdk.NewCoins(sdk.NewCoin(denom.Cent, sdk.NewInt(50))),
			},
			d: "1.5 shrp + 1.5 shrp = 3 shrp -> add: 2 shrp, sub 50 cent",
		},
		{
			ic: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1)), sdk.NewCoin(denom.Cent, sdk.NewInt(50))),
			ia: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1)), sdk.NewCoin(denom.Cent, sdk.NewInt(70))),
			oa: AdjustmentCoins{
				Add: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(2))),
				Sub: sdk.NewCoins(sdk.NewCoin(denom.Cent, sdk.NewInt(30))),
			},
			d: "1.5 shrp + 1.7 shrp = 3.2 shrp -> add: 1 shrp, sub 30 cent",
		},
		{
			ic: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1)), sdk.NewCoin(denom.Cent, sdk.NewInt(50))),
			ia: sdk.NewCoins(sdk.NewCoin(denom.Cent, sdk.NewInt(50))),
			oa: AdjustmentCoins{
				Add: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1))),
				Sub: sdk.NewCoins(sdk.NewCoin(denom.Cent, sdk.NewInt(50))),
			},
		...
		{
			ic: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1)), sdk.NewCoin(denom.Cent, sdk.NewInt(50))),
			ia: sdk.NewCoins(sdk.NewCoin(denom.Cent, sdk.NewInt(70))),
			oa: AdjustmentCoins{
				Add: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1))),
				Sub: sdk.NewCoins(sdk.NewCoin(denom.Cent, sdk.NewInt(30))),
			},
		...
		{
			ic: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(1)), sdk.NewCoin(denom.Cent, sdk.NewInt(550))),
			ia: sdk.NewCoins(sdk.NewCoin(denom.Cent, sdk.NewInt(70))),
			oa: AdjustmentCoins{
				Add: sdk.NewCoins(sdk.NewCoin(denom.ShrP, sdk.NewInt(6))),
				Sub: sdk.NewCoins(sdk.NewCoin(denom.Cent, sdk.NewInt(530))),
			},
	...
	testCases := []testCase{
		...
		},
		{
			iCurrent: sdk.NewCoins(
				...
				sdk.NewCoin(denom.Cent, sdk.NewInt(10)),
			),
			iRate: rate,
			...
			oCost: AdjustmentCoins{
				...
				Add: sdk.NewCoins(
					sdk.NewCoin(denom.Cent, sdk.NewInt(50)),
				),
			},
			oError: nil,
...
func TestParseShrpCoinsStr(t *testing.T) {
	...
	testCases := []testCase{
		...
		{
			i: "0.01",
			o: sdk.NewCoins(sdk.NewCoin(denom.Cent, sdk.NewInt(1))),
			d: "0.01 shrp -> 1 cent",
		},
		{
			i: "1.1",
		...
		},
		{
			i: "0.01",
			o: sdk.NewCoins(
				sdk.NewCoin(denom.Cent, sdk.NewInt(1)),
			),
			d: "0.01 shrp -> 1 cent",
		},
		{
